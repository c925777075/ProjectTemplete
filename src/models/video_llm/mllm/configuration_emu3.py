...
class Emu3Config(PretrainedConfig):
    ...
    def __init__(
        ...
        bos_token_id: int = 64001,
        eos_token_id: int = 64002,
        img_token_id: int = 64003,
        boi_token_id: int = 64004,
        eoi_token_id: int = 64005,
        eol_token_id: int = 64006,
        eof_token_id: int = 64007,
